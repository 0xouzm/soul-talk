...
return (new CustomEvent(event_name,(function (){var obj33823 = ({"detail":data});
return obj33823;
})()));
} else {
...
var f = (function (){var pred__33830 = cljs.core._EQ_;
var expr__33831 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33830.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33831))){
return ((function (pred__33830,expr__33831){
return (function (p1__33824_SHARP_){
return console.warn(p1__33824_SHARP_);
});
;})(pred__33830,expr__33831))
} else {
if(cljs.core.truth_(pred__33830.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33831))){
return ((function (pred__33830,expr__33831){
return (function (p1__33825_SHARP_){
return console.debug(p1__33825_SHARP_);
});
;})(pred__33830,expr__33831))
} else {
if(cljs.core.truth_(pred__33830.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33831))){
return ((function (pred__33830,expr__33831){
return (function (p1__33826_SHARP_){
return console.error(p1__33826_SHARP_);
});
;})(pred__33830,expr__33831))
} else {
return ((function (pred__33830,expr__33831){
return (function (p1__33827_SHARP_){
return console.log(p1__33827_SHARP_);
});
;})(pred__33830,expr__33831))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33834){
var map__33835 = p__33834;
var map__33835__$1 = (((((!((map__33835 == null))))?(((((map__33835.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33835.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33835):map__33835);
var opts = map__33835__$1;
var eval_fn = cljs.core.get.call(null,map__33835__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33837_SHARP_);
});})(new_def))
);
...
return (function (p__33838){
var vec__33839 = p__33838;
var ky = cljs.core.nth.call(null,vec__33839,(0),null);
var v = cljs.core.nth.call(null,vec__33839,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1568097128500
