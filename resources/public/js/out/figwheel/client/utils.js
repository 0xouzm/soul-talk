...
return (new CustomEvent(event_name,(function (){var obj26918 = ({"detail":data});
return obj26918;
})()));
} else {
...
var f = (function (){var pred__26925 = cljs.core._EQ_;
var expr__26926 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26925.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26926))){
return ((function (pred__26925,expr__26926){
return (function (p1__26919_SHARP_){
return console.warn(p1__26919_SHARP_);
});
;})(pred__26925,expr__26926))
} else {
if(cljs.core.truth_(pred__26925.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26926))){
return ((function (pred__26925,expr__26926){
return (function (p1__26920_SHARP_){
return console.debug(p1__26920_SHARP_);
});
;})(pred__26925,expr__26926))
} else {
if(cljs.core.truth_(pred__26925.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26926))){
return ((function (pred__26925,expr__26926){
return (function (p1__26921_SHARP_){
return console.error(p1__26921_SHARP_);
});
;})(pred__26925,expr__26926))
} else {
return ((function (pred__26925,expr__26926){
return (function (p1__26922_SHARP_){
return console.log(p1__26922_SHARP_);
});
;})(pred__26925,expr__26926))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26929){
...
var eval_fn = cljs.core.get.call(null,map__26930__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26932_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26934,(0),null);
var v = cljs.core.nth.call(null,vec__26934,(1),null);
...
}catch (e26939){if((e26939 instanceof Error)){
var e = e26939;
return not_found;
} else {
throw e26939;
...
//# sourceMappingURL=utils.js.map?rel=1565953420006
