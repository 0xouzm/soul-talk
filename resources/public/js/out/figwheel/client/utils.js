...
return (new CustomEvent(event_name,(function (){var obj35482 = ({"detail":data});
return obj35482;
})()));
} else {
...
var f = (function (){var pred__35489 = cljs.core._EQ_;
var expr__35490 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35489.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35490))){
return ((function (pred__35489,expr__35490){
return (function (p1__35483_SHARP_){
return console.warn(p1__35483_SHARP_);
});
;})(pred__35489,expr__35490))
} else {
if(cljs.core.truth_(pred__35489.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35490))){
return ((function (pred__35489,expr__35490){
return (function (p1__35484_SHARP_){
return console.debug(p1__35484_SHARP_);
});
;})(pred__35489,expr__35490))
} else {
if(cljs.core.truth_(pred__35489.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35490))){
return ((function (pred__35489,expr__35490){
return (function (p1__35485_SHARP_){
return console.error(p1__35485_SHARP_);
});
;})(pred__35489,expr__35490))
} else {
return ((function (pred__35489,expr__35490){
return (function (p1__35486_SHARP_){
return console.log(p1__35486_SHARP_);
});
;})(pred__35489,expr__35490))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35493){
...
var eval_fn = cljs.core.get.call(null,map__35494__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35496_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35498,(0),null);
...
}catch (e35503){if((e35503 instanceof Error)){
var e = e35503;
return not_found;
} else {
throw e35503;
...
//# sourceMappingURL=utils.js.map?rel=1568179221114
