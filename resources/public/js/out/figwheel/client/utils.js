...
return (new CustomEvent(event_name,(function (){var obj28848 = ({"detail":data});
return obj28848;
})()));
} else {
...
var f = (function (){var pred__28855 = cljs.core._EQ_;
var expr__28856 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28855.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28856))){
return ((function (pred__28855,expr__28856){
return (function (p1__28849_SHARP_){
return console.warn(p1__28849_SHARP_);
});
;})(pred__28855,expr__28856))
} else {
if(cljs.core.truth_(pred__28855.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28856))){
return ((function (pred__28855,expr__28856){
return (function (p1__28850_SHARP_){
return console.debug(p1__28850_SHARP_);
});
;})(pred__28855,expr__28856))
} else {
if(cljs.core.truth_(pred__28855.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28856))){
return ((function (pred__28855,expr__28856){
return (function (p1__28851_SHARP_){
return console.error(p1__28851_SHARP_);
});
;})(pred__28855,expr__28856))
} else {
return ((function (pred__28855,expr__28856){
return (function (p1__28852_SHARP_){
return console.log(p1__28852_SHARP_);
});
;})(pred__28855,expr__28856))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28859){
var map__28860 = p__28859;
var map__28860__$1 = (((((!((map__28860 == null))))?(((((map__28860.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28860.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28860):map__28860);
var opts = map__28860__$1;
var eval_fn = cljs.core.get.call(null,map__28860__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28862_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28864,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1568085256584
