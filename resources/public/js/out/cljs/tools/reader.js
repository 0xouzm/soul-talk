...
var G__23992 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__23992;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__23993 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23993,ch);
...
if(("\\" === ch__$1)){
var ch_23994__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_23994__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_23994__$2);
} else {
}

var G__23995 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__23995;
continue;
}
}
...
var vec__24003 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24003,(0),null);
var start_column = cljs.core.nth.call(null,vec__24003,(1),null);
...
var G__24006 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24006;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24007 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24008 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24008;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24007;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24009 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24009,(0),null);
var start_column = cljs.core.nth.call(null,vec__24009,(1),null);
...
var vec__24012 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24012,(0),null);
var end_column = cljs.core.nth.call(null,vec__24012,(1),null);
...
var vec__24015 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24015,(0),null);
var start_column = cljs.core.nth.call(null,vec__24015,(1),null);
...
var vec__24018 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24018,(0),null);
var end_column = cljs.core.nth.call(null,vec__24018,(1),null);
...
var vec__24021 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24021,(0),null);
var start_column = cljs.core.nth.call(null,vec__24021,(1),null);
...
var vec__24024 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24024,(0),null);
var end_column = cljs.core.nth.call(null,vec__24024,(1),null);
...
var sb = (function (){var G__24027 = (new goog.string.StringBuffer());
G__24027.append(initch);
...
var G__24029 = (function (){var G__24028 = sb;
G__24028.append(ch);

return G__24028;
})();
var G__24030 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24029;
ch = G__24030;
continue;
}
...
switch (G__24033) {
case "\\":
var G__24037 = (function (){var G__24034 = sb;
G__24034.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24034;
})();
var G__24038 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24037;
ch = G__24038;
continue;
...
break;
default:
var G__24039 = (function (){var G__24035 = sb;
G__24035.append(ch);

return G__24035;
})();
var G__24040 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24039;
ch = G__24040;
continue;
...
var vec__24041 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24041,(0),null);
var end_column = cljs.core.nth.call(null,vec__24041,(1),null);
...
var vec__24044 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24044,(0),null);
var column = cljs.core.nth.call(null,vec__24044,(1),null);
...
var vec__24049 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24049,(0),null);
var column = cljs.core.nth.call(null,vec__24049,(1),null);
...
var vec__24054 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24054,(0),null);
var column = cljs.core.nth.call(null,vec__24054,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24059 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24059,(0),null);
var start_column = cljs.core.nth.call(null,vec__24059,(1),null);
...
var vec__24062 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24062,(0),null);
var end_column = cljs.core.nth.call(null,vec__24062,(1),null);
...
var G__24065 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24065,true,null,opts,pending_forms);
...
var G__24066 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24066)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24066)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24066)){
...
var _STAR_suppress_read_STAR__orig_val__24067 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24068 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24068;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24067;
}});
...
var G__24069 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24069,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24069,rdr,first_line);
...
var G__24073 = matched;
var G__24074 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24073;
finished = G__24074;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24075 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24076 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24076;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24075;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24077 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24078 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24078;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24079 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24079,"(");
...
var G__24080 = (i + (1));
var G__24081 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24077;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24082 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24082);
...
var G__24083 = cljs.core.next.call(null,s__$1);
var G__24084 = ret;
s__$1 = G__24083;
r = G__24084;
continue;
...
var G__24085 = cljs.core.next.call(null,s);
var G__24086 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24085;
key_vals = G__24086;
continue;
} else {
...
var gensym_env_orig_val__24090 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24091 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24091;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24090;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24092 = token;
var G__24092__$1 = (((G__24092 == null))?null:cljs.core.subs.call(null,G__24092,(1)));
var G__24092__$2 = (((G__24092__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24092__$1));
var G__24092__$3 = (((G__24092__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24092__$2));
var G__24092__$4 = (((G__24092__$3 == null))?null:cljs.core.symbol.call(null,G__24092__$3));
if((G__24092__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24092__$4);
}
})():(function (){var G__24093 = token;
var G__24093__$1 = (((G__24093 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24093));
if((G__24093__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24093__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24104,reader){
var map__24105 = p__24104;
var map__24105__$1 = (((((!((map__24105 == null))))?(((((map__24105.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24105.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24105):map__24105);
var opts = map__24105__$1;
var eof = cljs.core.get.call(null,map__24105__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var G__24115 = (i__4731__auto___24114 + (1));
i__4731__auto___24114 = G__24115;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24111){
var G__24112 = cljs.core.first.call(null,seq24111);
var seq24111__$1 = cljs.core.next.call(null,seq24111);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24112,seq24111__$1);
});


//# sourceMappingURL=reader.js.map?rel=1568085254115
