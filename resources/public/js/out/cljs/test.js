...
var G__28409 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__28409,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__28409;
}
});
...
var len__4730__auto___28414 = arguments.length;
var i__4731__auto___28415 = (0);
while(true){
if((i__4731__auto___28415 < len__4730__auto___28414)){
args__4736__auto__.push((arguments[i__4731__auto___28415]));

var G__28416 = (i__4731__auto___28415 + (1));
i__4731__auto___28415 = G__28416;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq28411){
var G__28412 = cljs.core.first.call(null,seq28411);
var seq28411__$1 = cljs.core.next.call(null,seq28411);
var G__28413 = cljs.core.first.call(null,seq28411__$1);
var seq28411__$2 = cljs.core.next.call(null,seq28411__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28412,G__28413,seq28411__$2);
});
...
var file = cljs.core.get.call(null,map__28418__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__28418__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28418__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__28418,map__28418__$1,file,line,column){
return (function (p1__28417_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__28417_SHARP_));
});})(map__28418,map__28418__$1,file,line,column))
...
var temp__5720__auto___28420 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___28420)){
var message_28421 = temp__5720__auto___28420;
cljs.core.println.call(null,message_28421);
} else {
}
...
var temp__5720__auto___28422 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___28422)){
var message_28423 = temp__5720__auto___28422;
cljs.core.println.call(null,message_28423);
} else {
}
...
var output_dir__$1 = (function (){var G__28424 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__28424,"/"].join('');
} else {
return G__28424;
}
})();
...
var G__28426 = exception.stack;
var G__28426__$1 = (((G__28426 == null))?null:clojure.string.split_lines.call(null,G__28426));
var G__28426__$2 = (((G__28426__$1 == null))?null:cljs.core.get.call(null,G__28426__$1,depth));
if((G__28426__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__28426__$2);
}
} else {
...
var vec__28427 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__28427,(0),null);
var column = cljs.core.nth.call(null,vec__28427,(1),null);
var vec__28430 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__28430,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__28430,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__28430,(2),null);
...
var m__$1 = (function (){var G__28433 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__28433__$1 = (((G__28433 instanceof cljs.core.Keyword))?G__28433.fqn:null);
switch (G__28433__$1) {
case "fail":
...
var G__28437 = (function (){var G__28436 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__28436);
} else {
return G__28436;
}
})();
...
return cljs.core.vary_meta.call(null,G__28438,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__28442 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__28442,(0),null);
var types = vec__28442;
...
return cljs.core.map.call(null,(function (p__28445){
var vec__28446 = p__28445;
var ns = cljs.core.nth.call(null,vec__28446,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__28446,(1),null);
return ((function (vec__28446,ns,vars__$1){
return (function (){
...
var G__28449 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1){
return (function (){
var seq__28450 = cljs.core.seq.call(null,vars__$1);
var chunk__28451 = null;
var count__28452 = (0);
var i__28453 = (0);
while(true){
if((i__28453 < count__28452)){
var v = cljs.core._nth.call(null,chunk__28451,i__28453);
var temp__5720__auto___28455 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___28455)){
var t_28456 = temp__5720__auto___28455;
each_fixture_fn.call(null,((function (seq__28450,chunk__28451,count__28452,i__28453,t_28456,temp__5720__auto___28455,v,each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28456)));
});})(seq__28450,chunk__28451,count__28452,i__28453,t_28456,temp__5720__auto___28455,v,each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1))
);
} else {
}
...
var temp__5720__auto__ = cljs.core.seq.call(null,seq__28450);
if(temp__5720__auto__){
var seq__28450__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__28450__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__28450__$1);
var G__28461 = cljs.core.chunk_rest.call(null,seq__28450__$1);
var G__28462 = c__4550__auto__;
var G__28463 = cljs.core.count.call(null,c__4550__auto__);
var G__28464 = (0);
seq__28450 = G__28461;
...
var v = cljs.core.first.call(null,seq__28450__$1);
var temp__5720__auto___28465__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___28465__$1)){
var t_28466 = temp__5720__auto___28465__$1;
each_fixture_fn.call(null,((function (seq__28450,chunk__28451,count__28452,i__28453,t_28466,temp__5720__auto___28465__$1,v,seq__28450__$1,temp__5720__auto__,each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28466)));
});})(seq__28450,chunk__28451,count__28452,i__28453,t_28466,temp__5720__auto___28465__$1,v,seq__28450__$1,temp__5720__auto__,each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1))
);
} else {
}


var G__28467 = cljs.core.next.call(null,seq__28450__$1);
var G__28468 = null;
var G__28469 = (0);
var G__28470 = (0);
seq__28450 = G__28467;
chunk__28451 = G__28468;
count__28452 = G__28469;
i__28453 = G__28470;
continue;
}
} else {
...
});})(each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1))
);
});})(each_fixture_fn,G__28449,G__28449__$1,env,once_fixtures,each_fixtures,vec__28446,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1568179216753
